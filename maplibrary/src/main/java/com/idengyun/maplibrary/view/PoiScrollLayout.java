 ...
 * @Desc: 地图下方的poi列表滑动
 * @Author: zhoubo
 * @CreateDate: 2020-03-10 09:51
 */

public class PoiScrollLayout extends ViewGroup {

    public PoiScrollLayout(Context context) {
        this(context, null);
    }

    public PoiScrollLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PoiScrollLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private int slideSlop = SizeUtils.dp2px(45);
    private int offsetB = SizeUtils.dp2px(100);
    ...
    private int child_default_height = SizeUtils.dp2px(192);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        offsetClose = offsetY + 40 - height;//负数 向下移动到剩下40dp的高度
        offsetDefault = 0;
    ...
    private void setRecyclerViewLastY(boolean isScroll) {
        PoiScrollRecyclerView.canScroll = isScroll;
    }
