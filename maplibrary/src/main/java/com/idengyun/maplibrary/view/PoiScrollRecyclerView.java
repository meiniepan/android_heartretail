 ...
 * @Desc: poi列表的向上滑动
 * @Author: zhoubo
 * @CreateDate: 2020-03-09 16:21
 */

public class PoiScrollRecyclerView extends RecyclerView {

    public static boolean canScroll = true;
    public float lastY;

    public PoiScrollRecyclerView(Context context) {
        this(context, null);
    }

    public PoiScrollRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PoiScrollRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
