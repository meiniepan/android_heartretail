...
public abstract class SobotBaseActivity extends BaseActivity implements
		OnClickListener {
	...
	protected void onInitViews(Bundle savedInstanceState) {
		...
		int layoutContentId = getContentLayoutId();
		View.inflate(this, layoutContentId, mContentLayout);
		onContentChanged();
