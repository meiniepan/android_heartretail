...
public class SobotConsultationListActivity extends SobotBaseActivity {
    ...
    protected int getContentLayoutId() {
        return ResourceUtils.getIdByName(this, "layout", "sobot_activity_consultation_list");
    }
    ...
    private void initView() {
        ...
        sobot_ll_msg_center.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (info != null) {
                    SobotApi.startSobotChat(getApplicationContext(), info,null);// TODO: 2017/11/9 null是启动自己加的参数
                }
            }
        });
