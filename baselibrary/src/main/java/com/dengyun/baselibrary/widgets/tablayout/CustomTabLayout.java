...
/**
 * @Title 自定义Tablayout
 * @Desc: 可以配置底部菜单（可以带消息），其他tab自定义的功能
 * @Author: zhoubo
 * @CreateDate: 2018/11/14 4:43 PM
 */
public class CustomTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private TabFragmentChangeManager mTabFragmentChangeManager;
    ...
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
        mTabFragmentChangeManager = new TabFragmentChangeManager(fa.getSupportFragmentManager(), containerViewId, fragments);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.base_layout_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.base_layout_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.base_layout_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.base_layout_tab_top, null);
            }
    ...
    private void addTab(final int position, View tabView) {
        CustomTabEntity tableEntity = mTabEntitys.get(position);
        //设置标题
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
        tv_tab_title.setText(tableEntity.getTitle());
        //设置icon
        ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
        setTabViewIcon(iv_tab_icon,tableEntity,false);
        ...
        tabView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(null!=onInterceptTabClick){
                    isIntercept = onInterceptTabClick.onInterceptTab(position,position==mCurrentTab);
                }
...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                setTabViewIcon(iv_tab_icon,tabEntity,i==mCurrentTab);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            ImageView iv_tab_icon = (ImageView) tabView.findViewById(R.id.iv_tab_icon);
            CustomTabEntity tabEntity = mTabEntitys.get(i);
            setTabViewIcon(iv_tab_icon,tabEntity,isSelect);
    ...
    private void setTabViewIcon(ImageView iv,CustomTabEntity tabEntity,boolean isSelect){
        if(isSelect){
            if(TextUtils.isEmpty(tabEntity.getTabSelectedIconUrl())){
                iv.setImageResource(tabEntity.getTabSelectedIcon());
            }else {
                ImageApi.displayImage(getContext(),iv, tabEntity.getTabSelectedIconUrl(),tabEntity.getTabSelectedIcon(),tabEntity.getTabSelectedIcon());
            }
        }else {
            if(TextUtils.isEmpty(tabEntity.getTabUnselectedIconUrl())){
                iv.setImageResource(tabEntity.getTabUnselectedIcon());
            }else {
                ImageApi.displayImage(getContext(),iv, tabEntity.getTabUnselectedIconUrl(),tabEntity.getTabUnselectedIcon(),tabEntity.getTabUnselectedIcon());
            }
        }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setCurrentTab(int currentTab) {
        ...
        if (mTabFragmentChangeManager != null) {
            mTabFragmentChangeManager.setCurrentTab(currentTab);
        }
        if (mIndicatorAnimEnable) {
            calcOffset();
        } else {
    ...
    private OnInterceptTabClick onInterceptTabClick;

    public void setOnInterceptTabClick(OnInterceptTabClick onInterceptTabClick){
        this.onInterceptTabClick = onInterceptTabClick;
    }
