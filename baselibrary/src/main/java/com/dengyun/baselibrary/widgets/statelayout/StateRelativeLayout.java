...
/**
 * @titile  取代RelativeLayout布局的状态布局
...
public class StateRelativeLayout extends RelativeLayout {
    ...
    /*布局是RelativeLayout，使用RelativeLayout的LayoutParams*/
...
//    private OnClickListener mOnRetryClickListener;
    ...
    public final void showEmpty(View view, LayoutParams layoutParams) {
        ...
        if (null == mEmptyView) {
            ...
            // 添加LayoutParams时，加上和toolbar的位置关系，放在toolbar之下
            if (toolbarId!=0) {
                layoutParams.addRule(BELOW, toolbarId);
            }
    ...
    private void showContentView() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (toolbarId==0 && view instanceof Toolbar) {
                ...
                DEFAULT_LAYOUT_PARAMS.addRule(BELOW, toolbarId);
            }
