...
import com.dengyun.baselibrary.widgets.tablayout.TabMsgTextView;
 ...
 *  * 数字超过两位,显示99+
 * @Author: zhoubo
 * @CreateDate: 2018/11/14 6:51 PM
 */
public class UnreadMsgUtils {
    public static void show(TabMsgTextView msgView, int num) {
        if (msgView == null) {
            return;
        }
    ...
    public static void setSize(TabMsgTextView rtv, int size) {
        if (rtv == null) {
            return;
        }
