...
public class RxSchedulers {
    ...
    public static void doOnUIThread(@NonNull FragmentActivity activity, UITask uiTask) {
        doOnUIThread(ObjectUtils.getClassPath(activity), uiTask);
    }

    public static void doOnUIThread(@NonNull Fragment fragment, UITask uiTask) {
        doOnUIThread(ObjectUtils.getClassPath(fragment), uiTask);
    }
