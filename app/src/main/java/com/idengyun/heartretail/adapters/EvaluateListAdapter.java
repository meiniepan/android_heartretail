 ...
 */
public class EvaluateListAdapter extends BaseQuickAdapter<OrderStatusBean, BaseViewHolder> {
    public EvaluateListAdapter(int layoutResId, @Nullable List<OrderStatusBean> data) {
